<template>
   <div>
    <div class="productWrapper" v-for="p in products" :key="p.id">

        <div class="imageWrapper">
            <div class="LazyLoad is-visible">
                <img class="image" :src="p.small_image" alt="3323"></div>
        </div>
        <div class="infoWrapper">
            <div class="nameWrapper">
                <div class="name">
                    <span class="nameTag nameText">{{p.name}}</span>
                </div>
                <div class="spec">
                    {{p.spec}}
                </div>
            ...
            <div class="priceWrapper">
                <div class="price">
                    <span class="f34">{{p.price|moneyFormat}}</span>
                </div>
                <div class="iconCartWrapper" @click="addToCart(p)">
                    <svg viewBox="0 0 52 52" class="icon iconCart">
                        <defs>
                            <radialGradient cx="27.0288363%" cy="10.3693483%" fx="27.0288363%"
                                            ...
                                            id="radialGradient-1">
                                <stop stop-color="#c62f2f" offset="0%"></stop>
                                <stop stop-color="#c62f2f" offset="100%"></stop>
                            </radialGradient>
                        </defs>
