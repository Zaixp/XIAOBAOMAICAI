<template>
    <div class="wrapper" data-index="3">
        <div class="itemWrapper"   @click="gotoGoods(product)">
            ...
            <div>
                ...
                <div class="priceWrapper">
                    ...
                    <div class="iconCartWrapper" @click.stop="addToCart(product)">
                        <svg viewBox="0 0 52 52" class="icon icon-60">
                            <defs>
                                <radialGradient cx="27.0288363%" cy="10.3693483%" fx="27.0288363%" fy="10.3693483%" r="93.8427229%" id="radialGradient-1"><stop stop-color="#c62f2f" offset="0%"></stop><stop stop-color="#c62f2f" offset="100%"></stop></radialGradient>
                            </defs>
